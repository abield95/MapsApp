...
public class MapsActivity extends NavigationDrawerClass {
    ...
    /**
     *Used for adding a marker to the map
     * @param title The tittle for the marker
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            if ((mLastKnownLocation = task.getResult()) != null ) {
